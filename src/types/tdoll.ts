...
/** Where a skill description names one of the doll's exclusive equipment items, as generated by the importer. */
export interface SkillEquipmentMention {
	/** The exact wording in the description. */
	text: string;
	/** Id of the exclusive equipment item it names. */
	id: number;
}
...
export interface RawSkill {
	...
	/** Where the description names the doll's exclusive equipment. Empty for most skills. */
	equipmentMentions: SkillEquipmentMention[];
...
/** How long a doll takes to build and which production pools can give it. */
export interface DollProduction {
	/** Build time in seconds. */
	seconds: number;
	/** True when standard production can give the doll. */
	standard: boolean;
	/** True when heavy production can give the doll. */
	heavy: boolean;
}
