...
/**
 * The doll's portrait card, its stat table, with the "back to Normal" and full-art floating buttons.
 *
 ...
 */
export default function OverviewPanel({ showSkin, tdollImage, onCardImageClick, dollName, onSwitchToNormalArt, normalId, stats }: OverviewPanelProps) {
