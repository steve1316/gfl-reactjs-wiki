...
test("levels that differ in wording fall back to null", () => {
	const levels = Array.from({ length: 10 }, (_v, i) => (i < 5 ? `Throws a flashbang for ${i}s.` : `Throws a stun grenade for ${i}s.`));
